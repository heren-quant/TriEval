...
task-level variation in benchmark responses. Estimation uses regularized 
Gaussian variational expectation–maximization (RGVEM).
...
| `data/README_data.md` | Data source and pre-processing instructions |
