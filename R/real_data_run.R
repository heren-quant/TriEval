# =============================================================================
# real_data_run.R
# Fits the RGVEM-based IRT model to the real dataset (ARC benchmark).
#
...
# -----------------------------------------------------------------------------
# Fit RGVEM (single lambda)
# -----------------------------------------------------------------------------
RGVEM_out <- RGVEM_main(
  resp          = resp,
  all_start     = all_start,
...
# -----------------------------------------------------------------------------
RGVEM_out$sig2_b_j
RGVEM_out$sig2_theta_i
RGVEM_out$theta_i

# -----------------------------------------------------------------------------
# Save results
# -----------------------------------------------------------------------------
main_alpha <- as.data.frame(t(RGVEM_out$alpha_main))
