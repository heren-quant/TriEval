...
# Prepares response/design subsets and starting values; does not run RGVEM.
# =============================================================================
...
# To load one sample for the existing RGVEM_main call:
...
# This also sets the global S used by R/main.R.
# Choose lambda explicitly: for comparable relative shrinkage to the
# lambda = 30 full-data example, use lambda = 30 * S / N_full and c = 0.04 * S.
